              ...
              <div className='row'>
                <div className='col-12 swiper-slide-1'>
                  <div className='grid-category grid-category-style-2'>
                      ...
                      <Link href='#' legacyBehavior>
                        <a>
                          ...
                          <div className='category-info'>
                            <h3 className='text-heading-6'>Event Management</h3>
                          </div>
                        </a>
                      </Link>
                    </div>
                    <div className='grid-image-bottom'>
                      <Link href='#' legacyBehavior>
                        <a>
                          <img src='/assets/imgs/experimental.png' />
                        </a>
                      </Link>
                    </div>
                  </div>
                ...
                <div className='col-12 swiper-slide-1'>
                  <div className='grid-category grid-category-style-2'>
                    <div className='grid-image-left-category'>
                      <Link href='#' legacyBehavior>
                        <a>
                          ...
                          <div className='category-info'>
                            <h3 className='text-heading-6'>Market Research</h3>
                          </div>
                        </a>
                      </Link>
                    </div>
                    <div className='grid-image-bottom'>
                      <Link href='#' legacyBehavior>
                        <a>
                          <img src='/assets/imgs/reserch.png' />
                        </a>
                      </Link>
                    </div>
                  </div>
                ...
                <div className='col-12 swiper-slide-2'>
                  <div className='grid-category grid-category-style-2'>
                    <div className='grid-image-left-category'>
                      <Link
                        href='https://beempowered.netlify.app/'
                        target='_blank'
                        legacyBehavior
                      >
                        <a>
                          ...
                          <div className='category-info'>
                            ...
                            <p className='text-body-lead-large color-gray-500 mt-10'></p>
                    ...
                    <div className='grid-image-bottom'>
                      <Link href='#' legacyBehavior>
                        <a>
                          <img src='/assets/imgs/be-empowered.png' />
                        </a>
                      </Link>
                    </div>
                  </div>
